        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">Créez votre compte pour accéder aux offres de stage</p>
                </div>
                
                <form method="post" action="registration_student.php" class="needs-validation" novalidate>
                    <div class="mb-3">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 mb-0">
                        <small class="text-muted">
                            ...
                            <a href="registration_company.php">Inscription entreprise</a>
                        </small>
                    </p>
                </div>
            </div>
